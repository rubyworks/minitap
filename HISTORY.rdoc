...
This release include two basic improvements: better backtrace filtering
and file fields are given relative to current working directory
instead of absolute paths. In future maybe this can be configurable,
if someone makes the case that absolute paths are needed.
